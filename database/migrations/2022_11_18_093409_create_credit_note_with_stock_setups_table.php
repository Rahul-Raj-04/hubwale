...
class CreateCreditNoteWithStockSetupsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('credit_note_with_stock_setups', function (Blueprint $table) {
            $table->id();
    ...
    {
        Schema::dropIfExists('credit_note_with_stock_setups');
    }
}
