...
class CreateJobworkInsTable extends Migration
{
    /**
     * Run the migrations.
     *
    ...
    public function up()
    {
        Schema::create('jobwork_ins', function (Blueprint $table) {
            $table->id();
            ...
            $table->unsignedBigInteger('nature_proccessing')->index()->nullable();
            $table->foreign('nature_proccessing')->references('id')->on('jobwork_types')->onDelete('cascade');
    ...
    {
        Schema::dropIfExists('jobwork_ins');
    }
}
