...
namespace App\Http\Controllers\Livewire\Erp\Gst\GstEntry\CashPayment;
...
class Edit extends Component
{
	...
	public function mount($id)
	{
		...
		$this->cashPayment = GstEntry::find($id);
		$this->account_id = $this->cashPayment->account_id;
		$this->date = $this->cashPayment->date;
		$this->utilization_type = $this->cashPayment->utilization_type;
		$this->vou_no = $this->cashPayment->vou_no;
		$this->period = $this->cashPayment->period;
		$this->chq_dd_date = $this->cashPayment->chq_dd_date;
		$this->chq_dd_no = $this->cashPayment->chq_dd_no;
		$this->challan_date = $this->cashPayment->challan_date;
		$this->challan_no = $this->cashPayment->challan_no;
		$this->tax = json_decode($this->cashPayment->tax, TRUE);
		$this->interest = json_decode($this->cashPayment->interest, TRUE);
		$this->penalty = json_decode($this->cashPayment->penalty, TRUE);
		$this->fees = json_decode($this->cashPayment->fees, TRUE);
		$this->other = json_decode($this->cashPayment->other, TRUE);
		$this->total = json_decode($this->cashPayment->total, TRUE);
		$this->amount = $this->cashPayment->amount;
		$this->narration = $this->cashPayment->narration;
	...
	public function submit()
	{
		...
		$this->cashPayment->account_id = $this->account_id;
		$this->cashPayment->date = $this->date;
		$this->cashPayment->utilization_type = $this->utilization_type;
		$this->cashPayment->vou_no = $this->vou_no;
		$this->cashPayment->period = $this->period;
		$this->cashPayment->chq_dd_date = $this->chq_dd_date;
		$this->cashPayment->chq_dd_no = $this->chq_dd_no;
		$this->cashPayment->challan_date = $this->challan_date;
		$this->cashPayment->challan_no = $this->challan_no;
		$this->cashPayment->tax = json_encode($this->tax);
		$this->cashPayment->interest = json_encode($this->interest);
		$this->cashPayment->penalty = json_encode($this->penalty);
		$this->cashPayment->fees = json_encode($this->fees);
		$this->cashPayment->other = json_encode($this->other);
		$this->cashPayment->total = json_encode($this->total);
		$this->cashPayment->amount = $this->amount;
		$this->cashPayment->narration = $this->narration;
		$this->cashPayment->save();
        		...
        		<form wire:submit.prevent="submit">
                    <div class="row">
                        ...
                        <div class="col-md-6">
                            ...
                            <input type="date" class="form-control form-control-sm" wire:model="chq_dd_date" disabled>
                            @error('chq_dd_date')
                                <span class="text-danger small wow flash">{{ $message }}</span>
                            @enderror
                        </div>
                        <div class="col-md-6">
                            ...
                            <input type="text" class="form-control form-control-sm" placeholder="Enter chq dd no" wire:model="chq_dd_no" disabled>
                            @error('chq_dd_no')
                                <span class="text-danger small wow flash">{{ $message }}</span>
                            @enderror
                        </div>
