...
class AddGstCommodity extends Component
{
    ...
    public function saveSlab()
    {
        ...
        toast('GST Commodity created successfully!', 'success');
                    ...
                    <div class="row">
                        ...
                        <div class="col-md-6 mb-4">
                            ...
                            <input type="date" class="form-control form-control-sm @error('applied_at') is-invalid @enderror" 
                                wire:model.defer="applied_at" placeholder="Enter Integrated tax" required>
                            @error('applied_at')
                                <span class="text-danger small wow flash">{{ $message }}</span>
                            @enderror
                        </div>
