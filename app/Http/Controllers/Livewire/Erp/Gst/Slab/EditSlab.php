...
class EditSlab extends Component
{
    public $gst_types = [];
    public $gstSlab;
    ...
    {
        $this->gstSlab = GstSlab::find($id);

        $this->gst_slab = $this->gstSlab->gst_slab;
        $this->gst_type = $this->gstSlab->gst_type;
        $this->state_ut_tax = $this->gstSlab->state_ut_tax;
        $this->central_tax = $this->gstSlab->central_tax;
        $this->integrated_tax = $this->gstSlab->integrated_tax;
    ...
    public function saveSlab()
    {
        ...
        toast('GST slab updated successfully!', 'success');
