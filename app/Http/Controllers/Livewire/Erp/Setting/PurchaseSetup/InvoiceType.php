...
class InvoiceType extends Component
{
    ...
    {
        return view('livewire.erp.setting.purchase-setup.invoice-type')->extends('erp.app');
    }
    ...
    public function saveInvoiceType()
    {
        ...
        return redirect()->route('erp.setting.purchase-setup.invoice-type');
    }
