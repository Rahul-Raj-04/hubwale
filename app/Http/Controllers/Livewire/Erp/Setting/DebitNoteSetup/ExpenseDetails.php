...
class ExpenseDetails extends Component
{
    ...
    public $expense_detail_type = 'debit-note';
    public $company_id;
    public $account_id;
    public $name;
    ...
    {
        return view('livewire.erp.setting.debit-note-setup.expense-details')->extends('erp.app');
    }
    ...
    public function mount()
    {
        ...
        $this->records = ErpSetupExpenseDetail::where(['company_id' => $this->company_id, 'expense_detail_type' => 'debit-note'])->get();
    }
    ...
    public function saveRecord()
    {
        ...
        return redirect()->route('erp.setting.debit-note-setup.expense-details');
    }
