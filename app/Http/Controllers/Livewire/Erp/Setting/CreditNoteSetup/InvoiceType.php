...
class InvoiceType extends Component
{
    ...
    public $invoice_type = 'credit-note';
    ...
    {
        return view('livewire.erp.setting.credit-note-setup.invoice-type')->extends('erp.app');
    }
    ...
    public function saveInvoiceType()
    {
        ...
        return redirect()->route('erp.setting.credit-note-setup.invoice-type');
    }
