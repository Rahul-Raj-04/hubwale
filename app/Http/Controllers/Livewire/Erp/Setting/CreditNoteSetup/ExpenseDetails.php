...
namespace App\Http\Controllers\Livewire\Erp\Setting\CreditNoteSetup;
...
class ExpenseDetails extends Component
{
    ...
    public $expense_detail_type = 'credit-note';
    public $company_id;
    public $account_id;
    public $name;
    ...
    {
        return view('livewire.erp.setting.credit-note-setup.expense-details')->extends('erp.app');
    }
    ...
    public function mount()
    {
        ...
        $this->records = ErpSetupExpenseDetail::where(['company_id' => $this->company_id, 'expense_detail_type' => 'credit-note'])->get();
    }
    ...
    public function saveRecord()
    {
        ...
        return redirect()->route('erp.setting.credit-note-setup.expense-details');
    }
