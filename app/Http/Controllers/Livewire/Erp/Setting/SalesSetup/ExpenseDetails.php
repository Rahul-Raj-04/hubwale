...
namespace App\Http\Controllers\Livewire\Erp\Setting\SalesSetup;
...
class ExpenseDetails extends Component
{
    ...
    public $expense_detail_type = 'sales';
    public $company_id;
    public $account_id;
    public $name;
    ...
    {
        return view('livewire.erp.setting.sales-setup.expense-details')->extends('erp.app');
    }
    ...
    public function mount()
    {
        ...
        $this->records = ErpSetupExpenseDetail::where(['company_id' => $this->company_id, 'expense_detail_type' => 'sales'])->get();
    }
    ...
    public function saveRecord()
    {
        ...
        return redirect()->route('erp.setting.sales-setup.expense-details');
    }
