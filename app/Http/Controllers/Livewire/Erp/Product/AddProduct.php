...
class AddProduct extends Component
{
    ...
    public function updatedImages()
    {
        ...
        $imageName = pathinfo($this->images[0]->getClientOriginalName(), PATHINFO_FILENAME);
    ...
    {
        redirect()->route('erp.products.index');
    }
    ...
    public function removeSelectedImage($key)
    {
                ...
                <form wire:submit.prevent="saveProduct" enctype="multipart/form-data">
                                    ...
                                    <div class="row justify-content-start" style="min-height: 200px;width:100%">
                                        @foreach($all_images as $key => $image)
                                            <div class="col-auto p-0 text-center me-6 mb-4 position-relative">
                                                ...
                                                <i class="fa fa-trash text-danger" aria-hidden="true" style="position: absolute; top: 4px; right: 5px" wire:click="removeSelectedImage({{$key}})"></i>
                                            </div>
                                        @endforeach
                                    </div>
                                @enderror
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-lg-4 col-md-6  mt-2">
                            ...
                            <span class="text-danger">*</span>
                            <input type="number" class="form-control form-control-sm" id="price_per_piece" wire:model.defer="price_per_piece">
