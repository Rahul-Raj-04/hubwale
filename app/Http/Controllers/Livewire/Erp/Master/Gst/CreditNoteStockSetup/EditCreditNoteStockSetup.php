...
class EditCreditNoteStockSetup extends Component
{
    public $accounts;
    public $gstCommoditys;
    public $CreditNoteStockSetup;
    ...
    {
        $this->CreditNoteStockSetup = CreditNoteWithStockSetup::find($id);
        $this->type = $this->CreditNoteStockSetup->type;
        $this->type_list = $this->CreditNoteStockSetup->gst_commodity_id;
        $this->sales_purchase_ac = $this->CreditNoteStockSetup->sales_purchase_ac_id;
    ...
    public function submit()
    {
        ...
        $this->CreditNoteStockSetup->update($data);

        toast('Credit note with stock setup updated successfully!', 'success');
        ...
        return <<<'blade'
            <div>
                <form wire:submit.prevent="submit">
                    ...
                    <input type="submit" id="CreditNoteStockSetupFormSubmit" class="d-none">
                </form>
            </div>
        blade;
    }
