...
class EditJWInSetup extends Component
{
    public $accounts;
    ...
    {
        $this->JWInSetup = JWInSetup::find($id);
        $this->type = $this->JWInSetup->type;
        $this->type_list = $this->JWInSetup->gst_commodity_id;
        $this->sales_purchase_ac = $this->JWInSetup->sales_purchase_ac_id;
    ...
    public function submit()
    {
        ...
        $this->JWInSetup->update($data);

        toast('JW in setup updated successfully!', 'success');
        ...
        return <<<'blade'
            <div>
                <form wire:submit.prevent="submit">
                    ...
                    <input type="submit" id="jwInSetupFormSubmit" class="d-none">
                </form>
            </div>
        blade;
    }
