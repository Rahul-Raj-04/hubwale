...
class EditJWOutSetup extends Component
{
    public $accounts;
    ...
    {
        $this->JWOutSetup = JWOutSetup::find($id);
        
        $this->type = $this->JWOutSetup->type;
        $this->type_list = $this->JWOutSetup->gst_commodity_id;
        $this->sales_purchase_ac = $this->JWOutSetup->sales_purchase_ac_id;
    ...
    public function submit()
    {
        ...
        $this->JWOutSetup->update($data);

        toast('JW out setup updated successfully!', 'success');
        ...
        return <<<'blade'
            <div>
                <form wire:submit.prevent="submit">
                    ...
                    <input type="submit" id="JWOutSetupFormSubmit" class="d-none">
                </form>
            </div>
        blade;
    }
