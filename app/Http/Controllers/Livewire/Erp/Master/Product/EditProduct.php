...
class EditProduct extends Component
{
    ...
    public function mount($product, $return_type)
    {
        $this->return_type = $return_type;
        $this->product = $product;
        $this->name = $product->name;
        $this->alias = $product->alias;
        $this->garment_product = $product->garment_product;
        $this->gst_commodity_id = $product->gst_commodity_id;
        $this->vat_commodity_id = $product->vat_commodity_id;
        $this->commodity_for_less = $product->commodity_for_less;
        $this->commodity_for_greater = $product->commodity_for_greater;
        $this->group_id = $product->group_id;
        $this->category_id = $product->category_id;
        $this->stock_required = $product->stock_required;
        $this->pricelist = $product->pricelist;
        $this->tcs = $product->tcs;
        $this->purchase_rate = $product->purchase_rate;
        $this->sales_rate = $product->sales_rate;
        $this->tax_paid_rate = $product->tax_paid_rate;
        $this->sales_unit_id = $product->sales_unit_id;
        $this->purchase_unit_id = $product->purchase_unit_id;
        $this->gst_unit = $product->gst_unit;
        $this->quantity = $product->quantity;
        $this->amount = $product->amount;
        $this->minimum_stock = $product->minimum_stock;
        $this->reorder_level = $product->reorder_level;
        $this->auto_production = $product->auto_production;
        $this->process_name = $product->process_name;
        $this->sales_conversion_factor = $product->sales_conversion_factor;
        $this->parchase_conversion_factor = $product->parchase_conversion_factor;
        $this->stock_conversion_factor = $product->stock_conversion_factor;
        $this->closing_stock_account = $product->closing_stock_account;
        $this->trending_account = $product->trending_account;
    ...
    public function saveProduct(){
        ...
        $this->product->alias = $this->alias;
        $this->product->garment_product = $this->garment_product;
        $this->product->gst_commodity_id = $this->gst_commodity_id;
        $this->product->vat_commodity_id = $this->vat_commodity_id;
        $this->product->commodity_for_less = $this->commodity_for_less;
        $this->product->commodity_for_greater = $this->commodity_for_greater;
        $this->product->group_id = $this->group_id;
        $this->product->category_id = $this->category_id;
        $this->product->stock_required = $this->stock_required;
        $this->product->pricelist = $this->pricelist;
        $this->product->tcs = $this->tcs;
        $this->product->purchase_rate = $this->purchase_rate;
        $this->product->sales_rate = $this->sales_rate;
        $this->product->tax_paid_rate = $this->tax_paid_rate;
        $this->product->sales_unit_id = $this->sales_unit_id;
        $this->product->purchase_unit_id = $this->purchase_unit_id;
        $this->product->gst_unit = $this->gst_unit;
        $this->product->quantity = $this->quantity;
        $this->product->amount = $this->amount;
        $this->product->minimum_stock = $this->minimum_stock;
        $this->product->reorder_level = $this->reorder_level;
        $this->product->auto_production = $this->auto_production;
        $this->product->process_name = $this->process_name;
        $this->product->sales_conversion_factor = $this->sales_conversion_factor;
        $this->product->parchase_conversion_factor = $this->parchase_conversion_factor;
        $this->product->stock_conversion_factor = $this->stock_conversion_factor;
        $this->product->closing_stock_account = $this->closing_stock_account;
        $this->product->trending_account = $this->trending_account;
        $this->product->save();
