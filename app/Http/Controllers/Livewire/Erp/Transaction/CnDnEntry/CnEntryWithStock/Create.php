...
class Create extends Component
{
	...
	public function mount()
	{
        ...
        $this->balance_type = 'cash';
        $this->effect = 'Increase Sales';
        $this->tax_bill_of_supply = 'Tax Invoice';
        $this->stock_effect = 1;
	}
    ...
    public function submit()
    {
        ...
        if (count($this->account_entries) == 0) {
            ...
            do{
                ...
                $cnEntryWithOutStock = CNDNEntry::where('group_id', $group_id)->get();    
            }while (count($cnEntryWithOutStock) > 0);
	        ...
	        toast('CN entry with stock created successfully!', 'success');
