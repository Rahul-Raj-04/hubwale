...
class Add extends Component
{
    ...
    public function mount($type)
    {
        ...
        $this->invoice_types = ErpSetupInvoiceType::where(['invoice_type' => 'sales', 'company_id' => auth()->user()->company_id])->get();
    ...
    public function submit()
    {
        ...
        do {
            ...
            $purchaseEntry = SaleEntry::where('group_id', $group_id)->get();    
        ...
        foreach ($this->antries as $key => $antry) {
            ...
            $saleEntry = SaleEntry::create($data);
            SalePurchaseTax::create([
                ...
                'round_off' => null,
                'sale_entry_id' => $saleEntry->id,
                'purchase_entry_id' => null,
                'erp_product_id' => $antry['product_name'],
                'entry_type' => 'sale_entry',
            ]);
        }
                            ...
                            <tbody>
                                ...
                                @foreach ($antries as $keys => $entry)
                                    <tr>
                                        ...
                                        <td>                                        
                                            <a href="javascript:void(0)" class="btn btn-sm btn-sm btn-outline-danger" wire:click=deleteEntry({{$keys}})>
