                            ...
                            <div class="dropdown d-flex profile-1">
                                ...
                                <div class="dropdown-menu dropdown-menu-end dropdown-menu-arrow">
                                    <div class="p-2">
                                        ...
                                        <div class="p-2 row">
                                            <a href="{{ route('erp.home') }}" class="btn btn-primary mb-2">
                                            ...
                                            <a href="{{ route('pdf-maker.home') }}" class="btn btn-primary mb-2">
                                                <div class="rounded text-center p-1">
                                                    <i class="fas fa-file-pdf fa-2x mb-4"></i>
                                                    <h5 class="mb-0">PDF Maker</h5>
                                                </div>
                                            </a>
                                            <a href="{{ route('e-commerce.home') }}" class="btn btn-primary mb-2">
                                                <div class="rounded text-center p-1">
...
<div class="sticky">
    ...
    <div class="app-sidebar" style="overflow-y: auto;">
        ...
        @include('festival-image.layout.menus')
    </div>
    <!--/APP-SIDEBAR-->
</div>