<div class="main-sidemenu">
    ...
    <ul class="side-menu mt-0 p-0">
        <li class="slide">
            <a class="side-menu__item has-link {{ request()->routeIs('festival-image.home') ? 'active' : ' ' }}"
                data-bs-toggle="slide" href="{{ route('festival-image.home') }}">
                <i class="side-menu__icon fas fa-columns"></i>
                <span class="side-menu__label">Home</span>
            </a>
        </li>
        <li class="slide">
            <a class="side-menu__item has-link {{ request()->routeIs('festival-image.all-images') ? 'active' : ' ' }}"
                data-bs-toggle="slide" href="{{ route('festival-image.all-images') }}">
                <i class="side-menu__icon fas fa-images"></i>
                <span class="side-menu__label">All Image's</span>
            </a>
        </li>
        <li class="slide">
            <a class="side-menu__item has-link {{ request()->routeIs('festival-image.image-editor') ? 'active' : ' ' }}"
                data-bs-toggle="slide" href="{{ route('festival-image.image-editor') }}">
                <i class="side-menu__icon fa fa-pencil-square-o"></i>
                <span class="side-menu__label">Image Editor</span>
            </a>
        </li>
        <li class="slide">
