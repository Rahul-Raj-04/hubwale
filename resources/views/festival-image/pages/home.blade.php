            ...
            <div class="card-body p-2">
                ...
                <div class="col-md-12 p-5">
                    <div class="d-flex justify-content-between">
                        <h4>Upcoming Festival's</h4>
                        <a href="{{ route('festival-image.all-images') }}">View All</a>
                    </div>
                    <div>
                        @foreach ($festivalImage as $image)
                        <div class="column" style="width:200px;">
                            <div class="card card-sm border overflow-hidden p-0 br-7 shadow-sm">
                                ...
                                <div class="card-body">
                                    ...
                                    <div class="row mt-2">
                                        <div class="col-6">
                                            <button class="btn btn-secondary btn-sm customize-image-button" style="margin-left: -18px;"
                                                id="{{$image->id}}" data-bs-toggle="modal" data-bs-target="#customize-image">
                                                Customize
                                            </button>
                                        </div>
                                        <div class="col-6">
