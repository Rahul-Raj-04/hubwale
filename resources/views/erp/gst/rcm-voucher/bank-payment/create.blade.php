    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('erp.gst.rcm.bank-payment.store') }}" method="POST">
                        @method('POST')
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                            ...
                            <div class="col-md-6 mb-4">
                                <label class="form-label">Bank A/C Balance<i class="text-danger">*</i></label>
                                    <input type="text" class="form-control form-control-sm" name="bank_ac_balance" value="0" id="bank_ac_balance" disabled>
                            </div>
                            <div class="col-md-6">
                                ...
                                <select name='gst_type' class="form-control form-control-sm form-select" required>
                                    @foreach ($gst_types as $gst_type)
                                        <option value="{{ $gst_type }}"
                                            {{ old('account_id') == $gst_type ? 'selected' : '' }}>{{ $gst_type }}
                                        </option>
                                    @endforeach
                                </select>
                            </div>
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="number" class="form-control form-control-sm" value="{{ old('amount') }}" id="bank_amount" 
                            ...
                            <div class="col-md-6">
                                ...
                                <input type="date" class="form-control form-control-sm" value="{{ old('chq_dd_date') ? old('chq_dd_date') : date('Y-m-d') }}" 
