                ...
                <div class="card-header p-3">
                    ...
                    <div class="col-auto ms-auto d-print-none d-flex pe-0">
                        <div class="btn-list">
                            ...
                            @else
                                <a href="{{route('erp.account-transaction.cash-bank-entry.bank-payment.index')}}" class="btn btn-default btn-sm d-none d-sm-inline-block mx-2"><i class="fa fa-times me-2" aria-hidden="true"></i>{{ __('lang.cancel') }}</a>
                                <a href="{{ route('erp.account-transaction.cash-bank-entry.bank-payment.index') }}" class="btn btn-sm btn-default d-sm-none mx-2"><i class="fa fa-times me-2" aria-hidden="true"></i></a>
                            @endif
                        </div>
                        <div class="btn-list">
                            <label for="formSubmit" class="btn btn-sm btn-primary d-none d-sm-inline-block me-0"><i class="fas fa-save me-1"></i>Save Bank Payment</label>
