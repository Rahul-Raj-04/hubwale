        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header p-3">
                    ...
                    <div class="col-auto ms-auto d-print-none d-flex pe-0">
                        <div class="btn-list">
                            ...
                            @else
                                <a href="{{ route('erp.account-transaction.purchase-entry.index', ['type' => Request::get('type')]) }}" class="btn btn-sm btn-default d-none d-sm-inline-block mx-2"><i class="fa fa-arrow-left" aria-hidden="true"></i> Go Back</a>
                                <a href="{{ route('erp.account-transaction.purchase-entry.index', ['type' => Request::get('type')]) }}" class="btn btn-default btn-sm d-sm-none mx-2"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
                            @endif
                        </div>
                        <div class="btn-list">
                ...
                <div class="card-body p-3">
                    @livewire('erp.transaction.purchase-entry.edit', [ 'id' => $id, 'type' => Request::get('type'), 'return_type' => Request::get('return_type'), 'return_id' => Request::get('return_id')])     
                </div>
            </div>
        </div>
    </div>
