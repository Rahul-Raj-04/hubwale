        ...
        <div class="col-md-12">
            <div class="card">
                <div class="card-header p-3">
                    ...
                    <div class="col-auto ms-auto d-print-none d-flex pe-0">
                        <div class="btn-list">
                            ...
                            <a href="{{ route('erp.account-transaction.purchase-entry.index', ['type' => Request::get('type')]) }}" class="btn btn-sm btn-default d-sm-none mx-2"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
                        </div>
                        <div class="btn-list">
                ...
                <div class="card-body p-3">
                    @livewire('erp.transaction.purchase-entry.add', ['type' => Request::get('type')])     
                </div>
            </div>
        </div>
    </div>
