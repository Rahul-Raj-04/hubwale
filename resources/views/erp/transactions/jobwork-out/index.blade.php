                ...
                <div class="card-header p-3">
                    <ol class="breadcrumb">
                        ...
                        @else
                            ...
                            <li class="breadcrumb-item"><a href="javascript:void(0)">Jobwork Out</a></li>
                        @endif
                    ...
                    <div class="col-auto ms-auto d-print-none pe-0">
                        <div class="btn-list">
                            <a href="{{ route('erp.account-transaction.jobwork-out.create', ['type' => Request::get('type'), 'module' => Request::get('module')]) }}" class="btn btn-sm btn-primary d-none d-sm-inline-block me-0">
                                <i class="fas fa-plus me-1"></i>
                                Add {{ ucfirst(str_replace(['jobwork_in_', 'jobwork_out_', '_', ], ' ', Request::get('type'))) }}
                            </a>

                            <a href="{{ route('erp.account-transaction.jobwork-out.create', ['type' => Request::get('type'), 'module' => Request::get('module')]) }}" class="btn btn-sm btn-primary d-sm-none me-0">
                        ...
                        <table class="table table-bordered text-nowrap border-bottom datatable-common">
                            <thead>
                                <tr>
                                    ...
                                    @if(Request::get('type') == \App\Enum\Enum::JOBWORK_OUT_ORDER || Request::get('type') == \App\Enum\Enum::JOBWORK_OUT_ORDER_OPENING)
                                        <th class="bg-primary text-white">Date</th>
                                        <th class="bg-primary text-white">Order No</th>
                                    @endif
                                    @if(Request::get('type') == \App\Enum\Enum::JOBWORK_OUT_ISSUE ||  Request::get('type') == \App\Enum\Enum::JOBWORK_OUT_ISSUE_OPENING)
                                        <th class="bg-primary text-white">Date</th>
                                        <th class="bg-primary text-white">challan no</th>
                                    @endif
                                    @if(Request::get('type') == \App\Enum\Enum::JOBWORK_OUT_RECEIPT)
                                        <th class="bg-primary text-white">Date</th>
                                        <th class="bg-primary text-white">challan no</th>
                                        <th class="bg-primary text-white">vaucher no</th>
                                    @endif
                                    @if(Request::get('type') == \App\Enum\Enum::JOBWORK_OUT_BILLING)
                                        <th class="bg-primary text-white">Date</th>
                                        <th class="bg-primary text-white">billing no</th>
                                    @endif

                                    @if (Request::get('type') == \App\Enum\Enum::PHYSICAL_STOCK_VERIFICATION)
                                        <th class="bg-primary text-white">Date</th> 
                                        <th class="bg-primary text-white">vaucher no</th> 
                                    @else
                                    ...
                                    @if(Request::get('type') == \App\Enum\Enum::JOBWORK_OUT_ORDER || Request::get('type') == \App\Enum\Enum::JOBWORK_OUT_BILLING || Request::get('type') == \App\Enum\Enum::JOBWORK_OUT_ORDER_OPENING)
                                    ...
                                    @endif
                                        ...
                                        <td>
                                            ...
                                            <div class="{{ $val->is_audit == 1 ? 'd-none' : ''}} {{'edited-'.$val->group_id}}">
                                                <a href="{{route('erp.account-transaction.jobwork-out.edit', [ 'jobwork_out' => $val->id, 'type' => Request::get('type'), 'module' => Request::get('module')])}}" class="btn btn-sm btn-outline-info">
                                                    <span data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
                                                        <i class="fas fa-edit"></i>
                                                    </span>
                                                </a>
                            ...
                            <div class="modal-dialog modal-dialog-centered text-center" role="document">
                                <div class="modal-content tx-size-sm">
                                    <div class="modal-body text-center p-4 pb-5">
                                        ...
                                        <form action="{{ route('erp.account-transaction.jobwork-out.destroy', [ 'jobwork_out' => $val->id, 'type' => Request::get('type'), 'module' => Request::get('module')]) }}" method="POST" class="btn">
                                                @method('DELETE')
                                                @csrf
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form action="{{ route('erp.account-transaction.jobwork-out.filter') }}" method="GET">
                        @method('GET')
                        <div class="row">
                            @if(Request::get('type') == \App\Enum\Enum::JOBWORK_OUT_ORDER || Request::get('type') == \App\Enum\Enum::JOBWORK_OUT_ORDER_OPENING)
                ...
                <div class="modal-footer">
                    ...
                    <a href="{{ route('erp.account-transaction.jobwork-out.index', ['type' => Request::get('type'), 'module' => Request::get('module')]) }}" class="btn btn-danger" >Reset</a>
                </div>
            </div>
        </div>
    </div>
...
<script type="text/javascript">
        function updateIsAudit(id, group_id) {
            ...
            $.ajax({
                 type: "post",
                 url: "{{ route('erp.account-transaction.jobwork-out.update-is-audit')}}",
