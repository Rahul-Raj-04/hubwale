            ...
            <div class="card">
                <div class="card-header p-3">
                    ...
                    <div class="col-auto ms-auto d-print-none d-flex pe-0">
                        <div class="btn-list">
                            <a href="{{route('erp.account-transaction.jobwork-out.index', ['type' => Request::get('type'), 'module' => Request::get('module')])}}" class="btn btn-sm btn-default d-none d-sm-inline-block mx-2"><i class="fa fa-arrow-left" aria-hidden="true"></i> Go Back</a>
                ...
                <div class="card-body p-3">
                    @livewire('erp.transaction.jobwork-out.edit', [ 'id' => $id, 'type' => Request::get('type') , 'module' => Request::get('module')])     
                </div>
            </div>
        </div>
    </div>
