        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body p-3">
                    <div>
                        <form action="{{ route('erp.master.multi-currency.currency-master.update', $currencyMaster->id) }}" method="POST">
                            @method('PUT')
                            @csrf
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <label class="form-label">Symbol <i class="text-danger">*</i></label>
                                    <input type="text" class="form-control form-control-sm" maxlength="1" value="{{ old('symbol') ? old('symbol') : $currencyMaster->symbol }}" placeholder="Enter Symbol"
                                            name="symbol">
                                    @error('symbol')
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    @foreach ($countries as $country)
                                        @if($country->id == $currencyMaster->country_id)    
                                            <input type="text" class="form-control form-control-sm" value="{{ $country->name}}" name="country" id="country_id" readonly>
                                        @endif
                                    @endforeach
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control form-control-sm" value="{{ old('gc_code') ? old('gc_code') : $currencyMaster->gc_code }}"
                                            name="gc_code" id="gc_code" readonly>
                                </div>
                                <div class="col-md-6 mb-4">
                                    <label class="form-label">Integer<i class="text-danger">*</i></label>
                                    <input type="text" class="form-control form-control-sm" value="{{ old('integer') ? old('integer') : $currencyMaster->integer }}" placeholder="Enter Integer"
                                            name="integer">
                                </div>
                            </div>
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="text" class="form-control form-control-sm" value="{{ old('fraction') ? old('fraction') : $currencyMaster->fraction }}" placeholder="Enter Fraction"
                                            name="fraction">
                                </div>
                            </div>
