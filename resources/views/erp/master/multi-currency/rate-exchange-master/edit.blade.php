        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body p-3">
                    <div>
                        <form action="{{ route('erp.master.multi-currency.rate-exchange-master.update', $rateExchangeMaster->id) }}" method="POST">
                            @method('PUT')
                            @csrf
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <select name="currency_master_id" class="form-control form-control-sm form-select" id="country_id">
                                        ...
                                        @foreach ($currencyMasters as $currencyMaster)
                                            <option value="{{ $currencyMaster->id }}" {{(old('currency_master_id') ? old('currency_master_id') : $rateExchangeMaster->currency_master_id) == $currencyMaster->id ? 'selected' : ''}}>
                                ...
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="date" class="form-control form-control-sm" value="{{ old('date') ? old('date') : $rateExchangeMaster->date }}" name="date">
                                    @error('date')
                                        <span class="text-danger small wow flash">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="number" class="form-control form-control-sm" value="{{ old('standard_rate') ? old('standard_rate') : $rateExchangeMaster->standard_rate }}" placeholder="Enter Standard Rate" name="standard_rate">
                                    @error('standard_rate')
                                        <span class="text-danger small wow flash">{{ $message }}</span>
                                    @enderror
                                </div>
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="number" class="form-control form-control-sm" value="{{ old('selling_rate') ? old('selling_rate') : $rateExchangeMaster->selling_rate }}" placeholder="Enter Selling Rate" name="selling_rate">
                                    @error('selling_rate')
                                        <span class="text-danger small wow flash">{{ $message }}</span>
                                    @enderror
                                </div>
                            ...
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    ...
                                    <input type="number" class="form-control form-control-sm" value="{{ old('buyung_rate') ? old('buyung_rate') : $rateExchangeMaster->buyung_rate }}" placeholder="Enter Buying Rate"name="buyung_rate">
                                    @error('buyung_rate')
                                        <span class="text-danger small wow flash">{{ $message }}</span>
                                    @enderror
                                </div>
