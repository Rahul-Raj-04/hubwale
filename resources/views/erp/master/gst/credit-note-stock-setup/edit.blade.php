            ...
            <div class="card">
                <div class="card-header p-3">
                    ...
                    <div class="col-auto ms-auto d-print-none d-flex pe-0">
                        ...
                        <div class="btn-list">
                            <label for="CreditNoteStockSetupFormSubmit" class="btn btn-primary d-none btn-sm d-sm-inline-block me-0"><i class="fas fa-save me-1"></i> Save
                                Credit Note With Stock Setup</label>
                ...
                <div class="card-body p-3">
                    @livewire('erp.master.gst.credit-note-stock-setup.edit-credit-note-stock-setup', ['id' => $id])
                </div>
            </div>
        </div>
    </div>
