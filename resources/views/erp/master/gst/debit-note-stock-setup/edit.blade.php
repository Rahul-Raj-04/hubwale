            ...
            <div class="card">
                <div class="card-header p-3">
                    ...
                    <div class="col-auto ms-auto d-print-none d-flex pe-0">
                        ...
                        <div class="btn-list">
                            <label for="debitNoteStockSetupFormSubmit" class="btn btn-sm btn-primary d-none d-sm-inline-block me-0"><i class="fas fa-save me-1"></i> Save
                                Debit Note With Stock Setup</label>
                ...
                <div class="card-body p-3">
                    @livewire('erp.master.gst.debit-note-stock-setup.edit-debit-note-stock-setup', ['id' => $id])
                </div>
            </div>
        </div>
    </div>
