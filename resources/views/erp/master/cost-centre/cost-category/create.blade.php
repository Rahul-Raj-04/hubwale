        ...
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body p-3">
                    <div>
                        <form action="{{ route('erp.master.cost-centre.cost-category.store') }}" method="POST">
                            @method('POST')
                            @csrf
                            <div class="row">
                                <div class="col-md-6 mb-4">
                                    <label class="form-label"> Name <i class="text-danger">*</i></label>
                                    <input type="text" class="form-control form-control-sm" value="{{ old('name') }}" placeholder="Enter Category Name"
                                            name="name">
                                    @error('name')
