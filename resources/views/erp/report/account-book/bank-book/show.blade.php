                ...
                <div class="card-header p-3">
                    ...
                    <div class="col-auto ms-auto d-print-none pe-0">
                        <div class="col-auto ms-auto d-print-none pe-0">
                            <div class="d-flex">
                                <div class="btn-list">
                                    <a href="{{ route('erp.report.account-book.bank-book.index') }}" class="btn btn-sm btn-default d-sm-inline-block mx-2"><i class="fa fa-arrow-left" aria-hidden="true"></i>{{ __('lang.cancel') }}</a>
                            ...
                            <tbody>
                                @foreach($account_ledgers as $account_ledger)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('erp.report.account-book.bank-book.edit', $account_ledger->id)}}?account_id={{$account->id}}" class="{{$account_ledger->type == 'opening_balance' ? 'd-none' : ''}} btn btn-sm btn-outline-info" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
                            ...
                            <div class="modal-dialog modal-dialog-centered text-center" role="document">
                                <div class="modal-content tx-size-sm">
                                    <div class="modal-body text-center p-4 pb-5">
                                        ...
                                        <form action="{{ route('erp.report.account-book.bank-book.destroy', $account_ledger->id) }}" method="POST" class="btn">
                                                @method('DELETE')
                                                @csrf
