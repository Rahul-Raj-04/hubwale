            ...
            <div class="card">
                <div class="card-header p-3">
                    ...
                    <div class="col-auto ms-auto d-print-none pe-0">
                        <div class="btn-list">
                            <a href="{{ route('erp.master.account.create', ['add_type' => 'bank_book']) }}" class="btn btn-primary btn-sm d-none me-0 d-sm-inline-block">
                                <i class="fas fa-plus me-1"></i>
                                {{ __('lang.add') }}
                            </a>
                            <a href="{{ route('erp.master.account.create', ['add_type' => 'bank_book']) }}" class="btn btn-primary btn-sm me-0 d-sm-none">
                                <i class="fas fa-plus me-1"></i>
                            </a>
                        </div>
                    </div>
                        ...
                        <table class="table table-bordered text-nowrap border-bottom datatable-common">
                            <thead>
                                <tr>
                                    ...
                                    <th class="bg-primary text-white">Bank Account Name</th>
                            ...
                            <tbody>
                                @foreach($accounts as $account)
                                    <tr>
                                        ...
                                        <td>
                                            <a href="{{route('erp.report.account-book.bank-book.show', $account->id)}}" class="btn btn-sm btn-outline-success">Show</a>
                                            @if($account->is_default)
                                                <a href="{{ route('erp.master.account.edit', $account->id) }}?edit_type=bank_book" class="btn btn-sm btn-outline-info" data-bs-toggle="modal" data-bs-target="#is-default-modal">
                                            ...
                                            @else
                                                <a href="{{ route('erp.master.account.edit', $account->id) }}?edit_type=bank_book" class="btn btn-sm btn-outline-info" data-bs-toggle="tooltip" data-bs-placement="top" title="Edit">
                                                    <i class="fas fa-edit"></i>
                                                </a>
