...
@section('content')
            ...
            <div class="card">
                <div class="card-header">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Parchase Register</li>
                    </ol>
                    <div class="col-auto ms-auto d-print-none pe-0">
                        <div class="d-flex">
                            ...
                            <div class="btn-list">
                                <button class="btn btn-sm btn btn-sm btn-primary d-none d-sm-inline-block me-3">Export</button>
                        ...
                        <table class="table table-bordered text-nowrap border-bottom datatable-common">
                            <thead>
                                <tr>
                                    ...
                                    <th class="bg-primary text-white">Assessable Amount</th>
    ...
    <!-- Is Audit Alert -->
    <div class="modal fade" id="parchase-register-modal" tabindex="-1" aria-hidden="true">
        <div class="modal-dialog modal-dialog-centered text-center" role="document">
            <div class="modal-content tx-size-sm">
                <div class="modal-body text-center p-4 pb-5">
                    <form>
                            <div class="form-group row  mb-4">
                                <label for="type" class="form-label">Parchase Register Formate List</label>
                                <select class="form-control form-control-sm form-select" name="type" id="type" required>
                                    <option value="">Select type</option>
                                    <option value="">Parchase register ( with gst expese)</option>
                                </select>
                                @error('type')
...
<script type="text/javascript">
    $(document).ready(function() {
        $('#parchase-register-modal').modal('show');
    });
</script>
@endsection