            ...
            <div class="card">
                <div class="card-header">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Debit Note With Out Stock Register</li>
                    </ol>
                        ...
                        <div class="d-flex">
                            <form class="me-3 d-flex">
                                ...
                                <select class="form-control form-control-sm">
                                    ...
                                    <option value="Account Ledger">Debit Note With Out Stock Register</option>
                                </select>
                                </div>
