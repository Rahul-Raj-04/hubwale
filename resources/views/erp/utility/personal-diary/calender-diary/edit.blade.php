    ...
    <div class="row">
        <div class="col-md-12">
            <div class="card">
                ...
                <div class="card-body">
                    <form action="{{ route('erp.utility.personal-diary.calender-diary.update', $calenderDiary->id) }}" method="POST">
                        @method('PUT')
                        @csrf
                        <div class="row">
                            <div class="col-md-6">
                                <label class="form-label">Date <i class="text-danger">*</i></label>
                                <input type="date" class="form-control form-control-sm" value="{{ old('date') ? old('date') : $calenderDiary->date }}"
                                    name="date">
                                @error('date')
                            ...
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="time" class="form-control form-control-sm" value="{{ old('time') ? old('time') : $calenderDiary->time }}" placeholder="Enter time"
                                    name="time">
                                @error('time')
                                    <span class="text-danger small wow flash">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="number" class="form-control form-control-sm" value="{{ old('duration') ? old('duration') : $calenderDiary->duration }}" placeholder="Enter duration" name="duration">
                                @error('duration')
                                    <span class="text-danger small wow flash">{{ $message }}</span>
                                @enderror
                            </div>
                            <div class="col-md-6 mb-4">
                                ...
                                <select name='type' class="form-control form-control-sm form-select">
                                    ...
                                    <option value="Normal" {{ (old('type') ? old('type') : $calenderDiary->type) == 'Normal' ? 'selected' : '' }}>Normal</option>
                                    <option value="Important" {{ (old('type') ? old('type') : $calenderDiary->type) == 'Important' ? 'selected' : '' }}>Important</option>
                                    <option value="Very important" {{ (old('type') ? old('type') : $calenderDiary->type) == 'Very important' ? 'selected' : '' }}>Very Important</option>
                                </select>
                                @error('type')
                                    <span class="text-danger small wow flash">{{ $message }}</span>
                                @enderror
                        ...
                        <div class="row">
                            <div class="col-md-6 mb-4">
                                ...
                                <input type="text" class="form-control form-control-sm" value="{{ old('particulars') ? old('particulars') : $calenderDiary->particulars }}" name="particulars"
