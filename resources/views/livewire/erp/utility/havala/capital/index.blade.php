            ...
            <div class="card">
                ...
                <div class="card-body"> 
                    ...
                    <table class="table table-bordered text-nowrap border-bottom datatable-common">
                        <thead>
                            <tr>
                                ...
                                <th class="bg-primary text-white">Capital Account</th>
                                <th class="bg-primary text-white">Profit and Loss Account</th>
                                <th class="bg-primary text-white">Share</th>
                    ...
                    <div class="col-auto ms-auto d-print-none mt-5 pe-0">
                        <div class="btn-list">
                            <a href="{{ route('erp.utility.havala.capital.create') }}" class="btn btn-primary btn-sm d-none d-sm-inline-block me-1">
