            ...
            <div class="card">
                <div class="card-header">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Percentage Wise</li>
                    </ol>
                </div>
                ...
                <div class="card-body">
                        ...
                        <table class="table table-bordered text-nowrap border-bottom report_table">
                            <thead>
                                <tr>
                                    ...
                                    <th class="bg-primary text-white">Taxable (GST)</th>
                                    <th class="bg-primary text-white">Central Tax</th>
                                    <th class="bg-primary text-white">State/UT Tax</th>
                                    <th class="bg-primary text-white">Taxable (IGST)</th>
                    ...
                    <div class="col-auto ms-auto d-print-none mt-5 pe-0">
                        <div class="btn-list">
                            ...
                            <button id="format" class="btn btn-primary btn-sm d-none d-sm-inline-block me-1"
                                data-bs-toggle="modal" data-bs-target="#filter_account"><i class="fas fa-filter"></i>
                                Format</button>
                            <button class="btn btn-primary btn-sm d-sm-none me-1" data-bs-toggle="modal"
                                data-bs-target="#filter_account">
                            ...
                            <button id="month"
                                class="btn btn-primary btn-sm d-none d-sm-inline-block me-1">Month</button>
                        </div>
                    </div>
                </div>
            </div>
