            ...
            <div class="card">
                <div class="card-header">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Date Wise Summary</li>
                    </ol>
                    <div class="col-auto ms-auto d-print-none pe-0">
                        <div class="btn-list">
                        	<div class="d-flex">
                            	<form class="me-2">
    	                            	<input type="date" class="form-control form-control-sm btn d-none d-sm-inline-block" 
    	                                wire:model="date">
                            	</form>
                            ...
                            <tbody>
                               	@foreach ($rcmVouchers as $key => $rcmVoucher)
                                    <tr>
                                        ...
                                        <td>{{ $rcmVoucher->opposite_account->name }}</td>
                                        <td>{{ $rcmVoucher->amount }}</td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
                                        <td></td>
