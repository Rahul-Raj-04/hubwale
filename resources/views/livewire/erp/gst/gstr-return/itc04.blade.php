            ...
            <div class="card">
                <div class="card-header">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">ITC-04</li>
                    </ol>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered text-nowrap border-bottom datatable-common">
                            <thead>
                                <tr>
                                    <th class="bg-primary text-white">GSTIN of Job <br> Worker(JW)</th>
                                    <th class="bg-primary text-white">State</th>
                                    <th class="bg-primary text-white">Job Worker's Type</th>
                                    <th class="bg-primary text-white">Challan No</th>
                                    <th class="bg-primary text-white">Challan Date</th>
                                    <th class="bg-primary text-white">Types of Goods</th>
                                    <th class="bg-primary text-white">Description of Goods</th>
                                    <th class="bg-primary text-white">Unique Quantity Code (UQC)</th>
