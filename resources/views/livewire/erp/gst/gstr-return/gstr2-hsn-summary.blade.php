            ...
            <div class="card">
                <div class="card-header">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">GSTR 2 HSN Summary</li>
                    </ol>
                        ...
                        <div class="row mb-3">
                            <div class="col">
                                <select class="form-control form-select form-control-sm" id="format-input">
                                    <option>GSTR 2 HSNWise Summary</option>
                                </select>
                            </div>
                        ...
                        <table class="table table-bordered text-nowrap border-bottom datatable-common">
                            <thead>
                                <tr>
                                    ...
                                    <th class="bg-primary text-white">HSN</th>
                                    <th class="bg-primary text-white">Description</th>
                                    <th class="bg-primary text-white">UQC</th>
                                    <th class="bg-primary text-white">Total Qty</th>
                                    <th class="bg-primary text-white">Total Value</th>
