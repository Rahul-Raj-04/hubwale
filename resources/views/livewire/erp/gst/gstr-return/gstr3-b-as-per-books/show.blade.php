            ...
            <div class="card">
                <div class="card-header">
                    ...
                    <div class="col-auto ms-auto d-print-none pe-0">
                        <div class="btn-list">
                            <div class="btn-list">
                                <a href="{{ route('erp.gst.gstr-return.gstr-3-b-as-per-books.index') }}" class="btn btn-sm btn-default d-none d-sm-inline-block mx-2"><i class="fa fa-arrow-left" aria-hidden="true"></i> Go Back</a>
                                <a href="{{ route('erp.gst.gstr-return.gstr-3-b-as-per-books.index') }}" class="btn btn-sm btn-default d-sm-none mx-2"><i class="fa fa-arrow-left" aria-hidden="true"></i></a>
                            </div>
                        </div>
                    </div>
                </div>
