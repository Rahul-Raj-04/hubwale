        ...
        <div class="card">
            <div class="card-header p-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">Fund Flow</li>
                </ol>
            </div>
            <div class="card-body p-2">
                ...
                <div class="table-responsive">
                    <table class="table table-bordered text-nowrap border-bottom datatable-common">
                        <thead>
                            <tr>
                                <th class="bg-primary text-white" rowspan="2">Particulars</th>
                                <th class="bg-primary text-white" colspan="2">Working Capital</th>
                                <th class="bg-primary text-white" rowspan="2">Fund Flow</th>
                            </tr>
                            <tr>
