        ...
        <div class="card">
            <div class="card-header p-3">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item"><a href="#">Email Report</a></li>
                    <li class="breadcrumb-item active" aria-current="page">Other Email</li>
                </ol>
            </div>
                    ...
                    <div class="row">
                        <div class="col-md-3">
                            <select class="form-control form-control-sm">
                                <option>E-mail Log Report</option>
                            </select>
                        </div>
                        <div class="col-md-3">
                    ...
                    <table class="table table-bordered text-nowrap border-bottom datatable-common">
                        <thead>
                            <tr>
                                ...
                                <th class="bg-primary text-white">E-mail Type</th>
                                <th class="bg-primary text-white">Date</th>
                                <th class="bg-primary text-white">E-mail ID</th>
                                <th class="bg-primary text-white">E-mail Subject</th>
                                <th class="bg-primary text-white">Sent Status</th>
                                <th class="bg-primary text-white">E-Way Bill</th>
                            </tr>
                        </thead>
                        <tbody>
                            <tr>
