        ...
        <div class="card">
            <div class="card-header">
                <ol class="breadcrumb">
                    ...
                    <li class="breadcrumb-item active" aria-current="page">P&L Statement</li>
                </ol>
            </div>
            <div class="card-body">
                <form>
                        ...
                        <table class="table table-bordered text-nowrap border-bottom datatable-common">
                            <thead>
                                <tr>
                                    ...
                                    <th class="bg-primary text-white text-center">Income</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
                    ...
                    <div class="col-md-6 table-responsive">
                        <table class="table table-bordered text-nowrap border-bottom datatable-common">
                            <thead>
                                <tr>
                                    <th class="bg-primary text-white text-center"></th>
                                    <th class="bg-primary text-white text-center">Expense</th>
                                </tr>
                            </thead>
                            <tbody>
                                <tr>
