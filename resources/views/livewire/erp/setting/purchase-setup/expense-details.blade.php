<div class="row row-sm m-1">
            ...
            <div class="card-header p-3">
                <div>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Purchase Expense Name</li>
                    </ol>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Setup -> Purchase Setup -> Expense Details -> Purchase Expense Name</h5>
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <div class="row">
                                ...
                                <select name="type" class="form-control form-control-sm col-md-9" wire:model.defer="ac_effect">
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <div class="row">
                                ...
                                <input type="text" class="form-control form-control-sm col-md-9" wire:model.defer="serial_number">
                            </div>
                            @error('serial_number')
                            <span class="text-danger small wow flash">{{ $message }}</span>
                            @enderror
                        ...
                        <div class="form-group col-md-6">
                            <div class="row">
                                ...
                                <div class="col-md-9 row">
                                    ...
                                    <div class="col-md-4">
                                        <input type="text" class="form-control form-control-sm" wire:model.defer="type_2_percentage">
                                    </div>
                                </div>
                            </div>
                            @error('type_2')
    ...
    <div class="modal fade" id="recordEditModal" tabindex="-1" aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Setup -> Purchase Setup -> Expense Details -> Expense Details Entry</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <div class="row">
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <div class="row">
                                <label class="col-md-3">A/c Effect</label>
                                <select name="type" class="form-control form-control-sm col-md-9" wire:model.defer="edit_ac_effect">
                                    @foreach ($ac_effect_items as $ac_effect_item)
                                    <option value="{{ $ac_effect_item }}">{{ $ac_effect_item }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <div class="row">
                                <label class="col-md-3">Serial No.</label>
                                <input type="text" class="form-control form-control-sm col-md-9" wire:model.defer="edit_serial_number">
                            </div>
                        ...
                        <div class="form-group col-md-6">
                            <div class="row">
                                <label class="col-md-3">Add/Deduct</label>
                                <select class="form-control form-control-sm col-md-9" wire:model.defer="edit_add_deduct">
                                    @foreach ($add_deduct_items as $add_deduct_item)
                                    <option value="{{ $add_deduct_item }}">{{ $add_deduct_item }}</option>
                                    @endforeach
                                </select>
                    ...
                    <div class="row">
                        <div class="form-group col-md-6">
                            <div class="row">
                                <label class="col-md-3">Calculation</label>
                                <select class="form-control form-control-sm col-md-9" wire:model.defer="edit_calculation">
                                    @foreach ($calculation_items as $calculation_item)
                                    <option value="{{ $calculation_item }}">{{ $calculation_item }}</option>
                                    @endforeach
                                </select>
                        ...
                        <div class="form-group col-md-6">
                            <div class="row">
                                <label class="col-md-3">Type</label>
                                <div class="col-md-9 row">
                                    <select class="form-control form-control-sm col-md-4" wire:model.defer="edit_type_2">
                                        @foreach ($type_2_items as $type_2_item)
                                        <option value="{{ $type_2_item }}">{{ $type_2_item }}</option>
                                        @endforeach
                                    </select>
                                    <span class="col-md-4"> @ %</span>
                                    <div class="col-md-4">
                                        <input type="text" class="form-control form-control-sm" wire:model.defer="edit_type_2_percentage">
                                    </div>
                                </div>
                            </div>
                            @error('edit_type_2')
                    ...
                    <div class="row">
                        ...
                        <div class="form-group col-md-6">
                            <div class="row">
                                <label class="col-md-3">A/c Name</label>
                                <select class="form-control form-control-sm col-md-9" wire:model.defer="edit_account_id">
                                    @foreach ($accounts as $account)
                                    <option value="{{ $account->id }}">{{ $account->name }}</option>
                                    @endforeach
                                </select>
