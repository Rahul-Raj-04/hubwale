            ...
            <div class="card-header p-3">
                <div>
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item active" aria-current="page">Invoice Type for Credit Note</li>
                    </ol>
                </div>
            </div>
        ...
        <div class="modal-dialog modal-dialog-centered modal-lg">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Setup -> Credit Note Setup -> Invoice Type -> Invoice Type
                        Entry</h5>
