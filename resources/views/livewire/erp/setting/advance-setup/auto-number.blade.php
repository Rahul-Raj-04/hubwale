<section>
                ...
                <div class="card-body">
                    <div class="table-responsive">
                        <table class="table table-bordered text-nowrap border-bottom datatable-common">
                            <thead>
                                <tr>
                                    <th class="bg-primary text-white">User Field</th>
                                    <th class="bg-primary text-white">User Field Name</th>
                                    <th class="bg-primary text-white">Prefix</th>
                                    <th class="bg-primary text-white">Suffix</th>
                                    <th class="bg-primary text-white">Last Number</th>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="addAutoNumber">
                        <div class="row">
                            <div class="col-md-6">
                                <label class="form-lable">User Field</label>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label class="form-lable">Prefix</label>
                            </div>
                            <div class="col-md-6">
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label class="form-lable">Suffix</label>
                            </div>
                            <div class="col-md-6">
                                <input type="text" class="form-control form-control-sm" required>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-6">
                                <label class="form-lable">Last No.</label>
                            </div>
                            <div class="col-md-6">
                                <input type="text" class="form-control form-control-sm" required>
                            </div>
    ...
    <div class="modal fade" id="userFieldEditModal" tabindex="-1" aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="editAutoNumber">
                        <div class="row">
                            <div class="col-md-6">
                                <label class="form-lable">User Field</label>
                            </div>
    ...
    <script>
        window.addEventListener('openAutoNumberEditModal', event => {
