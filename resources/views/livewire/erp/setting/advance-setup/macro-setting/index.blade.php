<section>
            ...
            <div class="card">
                <div class="card-header">
                    <ol class="breadcrumb">
                        ...
                        <li class="breadcrumb-item"><a href="javascript:void(0)">Macro Setting</a></li>
                        ...
                        <div class="col-auto ms-auto d-print-none mt-5 pe-0">
                            <div class="btn-list">
                                <a href="#" class="btn btn-primary btn-sm d-none d-sm-inline-block me-0"  data-bs-toggle="modal"
                                    data-bs-target="#add-macro">
                                    <i class="fas fa-plus me-1"></i>
                                    Add
                                </a>
                                <a href="#" class="btn btn-primary btn-sm d-sm-none me-0">
                                    <i class="fas fa-plus"></i>
                                </a>
                                <a href="#" class="btn btn-primary btn-sm me-0">
                                    Load
                                </a>
                                <a href="#" class="btn btn-primary btn-sm me-0">
                                    Default
    ...
    <!-- Add Macro -->
    <div class="modal fade" id="add-macro" tabindex="-1" aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="addMacro">
                        <div class="form-group mt-2">
                            <label for="group_name">Macro No</label>
                            <input type="text" class="form-control form-control-sm" wire:model.defer.defer="macro_no" required>
                        </div>
                        <div class="form-group mt-2">
                            <label for="group_short_name">Macro name</label>
                            <input type="text" class="form-control form-control-sm" wire:model.defer.defer="macro_name" required>
                        </div>
    ...
    <!-- Edit Macro -->
    <div class="modal fade" id="macroEditModal" tabindex="-1" aria-hidden="true" wire:ignore.self>
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <ol class="breadcrumb">
                ...
                <div class="modal-body">
                    <form wire:submit.prevent="updateMacro">
                        <div class="form-group mt-2">
                            <label for="group_name">Macro No</label>
                            <input type="text" class="form-control form-control-sm" wire:model.defer.defer="edit_macro_no" required>
                        </div>
                        <div class="form-group mt-2">
                            <label for="group_short_name">Macro name</label>
                            <input type="text" class="form-control form-control-sm" wire:model.defer.defer="edit_macro_name" required>
                        </div>
                        <input type="submit" id="editsubmitForm" class="d-none">
                    </form>
                </div>
                <div class="modal-footer">
                    <button type="button" class="btn me-auto modalCloseButton" data-bs-dismiss="modal">Close</button>
    ...
    <script>
        window.addEventListener('openMacroEditModal', event => {
